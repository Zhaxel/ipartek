 ...
 *
 */
final public class Bici extends Vehículo implements IVehiculo {
	...
	public Bici(int velocidadActual, boolean estarArracando) {
		this();
	...
	public int Acelerar(int incrementoVel) {
		...
		if (estarArracando && velocidadSiguiente < VEL_MAX_BICI) {
			System.out.println("Acelerando. Velocidad actual: " + velocidadSiguiente);
	...
	public String toString() {
		return "Bici [velocidadActual=" + velocidadActual + ", estarArracando=" + estarArracando + "]";
	}
